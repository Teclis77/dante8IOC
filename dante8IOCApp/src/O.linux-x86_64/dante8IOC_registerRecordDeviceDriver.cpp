...
/* Generated from ../O.Common/dante8IOC.dbd */
...
int dante8IOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/xlabsrv2/epics/IOCs/dante8IOC";
...
/* dante8IOC_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: dante8IOC_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(dante8IOC_registerRecordDeviceDriver(*iocshPpdbbase));
}
